...
export class HomePageComponent implements OnInit {
  ...
  reviews: ReviewModel[] = [
    {
      ...
      review:
        'Mise has changed the game in terms of simplicity and certainly been a lifesaver for expat living.',
      videoUrl: '',
    },
    {
      profileUrl: 'assets/us.png',
  ...
  toggleShowMenu() {
    ...
    this.scrollbar
      .getScrollbar()
      ?.updatePluginOptions('modal', { open: this.showMenu });
  }
  calculateAmount() {
    if (this.senderAmount >= 5000) {
      ...
      this.recipientAmount = (
        this.totalAmount / this.recipientCurrencyRate
      ).toFixed(2);
    } else {
